...
import 'widgets/job_carousel_card.dart';
import 'widgets/job_filter_modal.dart';
import 'widgets/jobs_tab_view.dart';
import 'widgets/morphic_job_sheet_wrapper.dart';
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        drawer: ProfileDrawer(
          onSelectNavIndex: (index) => setState(() => _currentNavIndex = index),
